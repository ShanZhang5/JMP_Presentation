...
<br/>
<br/>
 - Policy's effect on <span style="color:deeppink">negative-externality export</span>
<br/>
<br/>
...
- **Chapter 4** The effect of China's Waste Import Ban on Beach Cleanups (with Rebecca Taylor)
<br/>
<br/>
--
...
## U.S. Plastic Scrap Export Netweight by Regions

.pull-center[<img src="graphs/Chapter_2/trade_weight_by_region.png" width="800" height = "500">]
...
$$y_{it} = \alpha+ \beta D_{it}+\gamma X_{it} +\theta Z_{i}+\nu T_{t}+ \delta Z_{i}*T_{t} + \epsilon_{it}$$
.pull-center[<img src="graphs/Chapter_2/twfe_trade_regions.png" width="800" height = "350">]
...
.pull-center[
![description of the image](graphs/Chapter_2/event_study.png)]
...
## To Asia: U.S. Plastic Scrap Export Netweight
...
- **Other Countries imposed similar import control regulation as China (hyperlink to another page)**
...
## Results
.center[Fig 3.5 Correlations of State-level Causal Estimates by Significancy]
.pull-center[
...
## Results
.center[Fig 3.6 Correlations of State-level Emission Net Change]
.pull-center[
...
## Results
.center[Fig 3.7 Correlations of State-level Causal Estimates by Political Affiliation]
.pull-center[
...
.center[Fig 3.8 Data Comparison between CalRecycle, EPA and WBJ]
...
.pull-right[<img src="graphs/racial_disposal_plot.png" width="300" height = "400">]
<br/>
.center[
...
.center[Fig A.3.1 Average net increase in waste flows after the GS policy and Regional Racial Composition]
...
.center[Fig A.3.2 Data Source: CalRecycle and Waste Business Journal (WBJ)]
---
...
.center[Fig A.3.3 Data Source : CalRecycle and WBJ]
---
...
.center[Fig 3.10 **Gravity Model Estimates at Census Block level**]
---
...
.center[Fig 3.11 **Gravity Model Estimates at Census Block level**]
...
## Results prior to the GS Policy with s.d. Clusters
...
## Results after the GS Policy with s.d. Clusters
...
- **California Pollution Relocation** 
  ...
  - After China's GS policy
   ...
   waste relocated to places where have <span style="color:darkgreen">lower political costs</span> 
---
...
**<font size="5">The effect of China's Waste Import Ban on Beach Cleanups<font size="5">**
]
...
- China's GS Policy diverted developed countries recyclable waste exports from China to other developing and underdeveloped countries
...
## Export Countries' Beach Cleanups

.pull-center[
![description of the image](graphs/Chapter_4/Trade_and_beach_cleanup_exporters.png)]
.center[Fig 4.1]
---
...
.pull-center[
![description of the image](graphs/Chapter_4/Trade_and_beach_cleanup_importers_and_china.png)]
.center[Fig 4.2]
---
...
.pull-center[
![description of the image](graphs/Chapter_4/Trade_and_beach_cleanup_importers.png)]
.center[Fig 4.3]
---
...
.pull-center[
![description of the image](graphs/Chapter_4/Trade_beach_cleanup_US_states.png)]
.center[Fig 4.4]
---
...
.pull-center[
![description of the image](graphs/Chapter_1/Prevention_survey.png)]
.center[Fig 5.1]
---
...
.pull-center[
![description of the image](graphs/Chapter_1/respondents_newscale.png)]
.center[Fig 5.2]
---
...
.pull-center[
![description of the image](graphs/Chapter_1/lasso_l1r1d1f0p1s0_nationalcasesdeaths.png)]
.center[Fig 5.3]
---
...
.pull-left[
![description of the image](graphs/Chapter_1/lasso_wtp_each_month_2020qtrs_2x2_ben99.png)]
.center[Fig 5.4]

.pull-right[
![description of the image](graphs/Chapter_1/lasso_wtp_each_month_2021qtrs_2x2_ben99.png)]
.center[Fig 5.5]
